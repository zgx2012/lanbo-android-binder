#ifndef FRAMEWORKS_BIGBITSET_H
#define FRAMEWORKS_BIGBITSET_H
...
struct BigBitSet {
    ...
    inline bool operator== (const BigBitSet& other) const { return value == other.value; }
    inline bool operator!= (const BigBitSet& other) const { return value != other.value; }
    inline BigBitSet operator& (const BigBitSet& other) const {
        return BigBitSet(value & other.value);
    }
    inline BigBitSet& operator&= (const BigBitSet& other) {
        value &= other.value;
        return *this;
    }
    inline BigBitSet operator| (const BigBitSet& other) const {
    ...
    inline BigBitSet operator~ () const {
        return BigBitSet(~ value);
    }
    inline BigBitSet& operator=(const BigBitSet& other)
    {
        value = other.value;
...
ANDROID_BASIC_TYPES_TRAITS(BigBitSet)

}; // end namespace android

#endif //FRAMEWORKS_BIGBITSET_H
